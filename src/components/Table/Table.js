...
const BasicTable = () => {
  const packages = useSelector(state => state.tasks.Package)
                  ...
                  <TableRow>
                    ...
                    <TableCell>
                      <motion.div
                        ...
                        className="Table"
                      >
                        {lastPackage.destination}
                      </motion.div>
                    </TableCell>

                    <TableCell>{lastPackage.discount}</TableCell>
                      ...
                      >
                        <div>
                          <Button
                            type="primary"
                            size="small"
                            onClick={() => abrirModal(lastPackage.details)}
                          >
                            Details
                          </Button>
                        </div>
                    ...
                    <TableCell align="left" className="Details">
                      <div>
                        <Button
                          type="primary"
                          size="small"
                          onClick={() => abrirModal(row.details)}
                        >
                          Details
                        </Button>
                      </div>
